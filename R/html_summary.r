pipeline.htmlSummary <- function(env)
{
  ...
  filename <- file.path(paste(env$files.name , "- Results"), "html", "style.css")
  ...
  <body>
    <header id=\"nav-menue\">
      <nav><ul>
        ...
        <li><a target=\"_self\" href=\"html/block1.html\">I Preprocessing & quality check </a></li>
        <li><a target=\"_self\" href=\"html/block2.html\">II Group annotation & stability</a></li>
        <li><a target=\"_self\" href=\"html/block3.html\">III Portraying</a>
        <li><a target=\"_self\" href=\"html/block4.html\">IV Similarity analyses</a></li>
        <li><a target=\"_self\" href=\"html/block5.html\">V Pseudotime estimation</a></li>
      </ul></nav>
    </header>
    ...
    <div id=\"wrapper\">
      ...
      <br>
      <dt>Number of single cells</dt>
      <dd>", ncol(env$seuratObject), "</dd>
      <dt>Number of samples/patients</dt>
      <dd>", length(unique(env$seuratObject$orig.ident)), "</dd>
      <dt>Number of Seurat clusters</dt>
      <dd>", length(unique(env$seuratObject$seurat_clusters)), "</dd>", sep="", file=outfile)

      if(env$preferences$preprocessing$create.meta.cells)
        cat("<dt>Number of meta cells</dt>
              <dd>", ncol(env$metadata), "</dd>", sep="", file=outfile)
  ...
  filename <- file.path(paste(env$files.name , "- Results"), "html", "block1.html")
  outfile <- file(filename, "w")
  ...
  cat("
    ...
    <body>
        ...
        <nav><ul>
					...
					<li><a href=\"block2.html\">II Group annotation & stability</a></li>
					<li><a href=\"block3.html\">III Portraying</a></li>
					<li><a href=\"block4.html\">IV Similarity analyses</a></li>
					<li><a href=\"block5.html\">V Pseudotime estimation</a></li>
				</ul></nav>
  		</header>
  ...
  cat("Read counts are preprocessed using standard workflow:<br>
    ...
    2) Cells with more than 7000 detected genes are removed.<br>
  ...
  cat("<h2>Similarity analyses</h2>
      ...
      They are colored according to original sample ids and clusters as provided by Seurat:<br>
      <br>
      <img src=\"../Data Overview/Sample IDs - tSNE.png\" width=48%>
      <img src=\"../Data Overview/Sample IDs - UMAP.png\" width=48%>
      <br><br>
      <img src=\"../Data Overview/Seurat clusters - tSNE.png\" width=48%>
      <img src=\"../Data Overview/Seurat clusters - UMAP.png\" width=48%>
      <br><br>

      For each Seurat cluster, marker genes were detected:
      <br>
      <img src=\"../Data Overview/Seurat clusters - markers.png\" width=98%>
  ...
  if(env$preferences$preprocessing$cellcycle.correction)
  {
    cat("Cell cycle prediction was applied to classify cells into G1 (G1 score above 0.5), G2/M (G2/M score above 0.5) or S phase (otherwise) based on
        ...
        <img src=\"../Data Overview/Cell cycle phase 1.png\" width=98%>
        <img src=\"../Data Overview/Cell cycle phase 2.png\" width=98%>", sep="", file=outfile)
  } else
  {
  ...
  filename <- file.path(paste(env$files.name , "- Results"), "html", "block2.html")
  outfile <- file(filename, "w")
  ...
  cat("<!DOCTYPE html>
      ...
      <head>
    	...
    	<body>
          ...
          <nav><ul>
            <li><a href=\"../Summary.html\">Overview</a></li>
            <li><a href=\"block1.html\">I Preprocessing & quality check</a></li>
            <li><a class=\"act\" href=\"block2.html\">II Group annotation & stability</a></li>
            <li><a href=\"block3.html\">III Portraying</a></li>
            <li><a href=\"block4.html\">IV Similarity analyses</a></li>
            <li><a href=\"block5.html\">V Pseudotime estimation</a></li>
          </ul></nav>
  ...
  filename <- file.path(paste(env$files.name , "- Results"), "html", "block3.html")
  outfile <- file(filename, "w")
  ...
  cat("<!DOCTYPE html>
      ...
      <body>
          ...
          <nav><ul>
            ...
            <li><a href=\"block1.html\">I Preprocessing & quality check</a></li>
            <li><a href=\"block2.html\">II Group annotation & stability</a></li>
            <li><a class=\"act\" href=\"block3.html\">III Portraying</a></li>
            <li><a href=\"block4.html\">IV Similarity analyses</a></li>
            <li><a href=\"block5.html\">V Pseudotime estimation</a></li>
          </ul></nav>
        </header>
      ...
      <h2>Cell expression portraits</h2>", sep="", file=outfile)

      if(file.exists(file.path(paste(env$files.name , "- Results"),"Expression portraits.pdf")))
      {
        cat("Each (single- or meta-) cell's expression landscape is described by the metagene expression values. They are arranged according to the underlying SOM grid and visualized by an appropriate color gradient (red and blue colors indicate over- and underexpressed metagenes, respectively; green and intermediate colors indicate no or low differential expression).
  ...
  cat("<h2>Gene localization and information table</h2>
      ...
      <object data=\"../Summary Sheets - Groups/Expression Portraits Groups.pdf\" type=\"application/pdf\" style=\"width:100%;height:600px;border:1px solid black\"></object>
  ...
  filename <- file.path(paste(env$files.name, "- Results"), "html", "block4.html")
  outfile <- file(filename, "w")
  ...
  cat("<!DOCTYPE html>
  	...
  	<head>
      <link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">
  		<title>Summary of SCRAT analysis results - Similarity analyses</title>
  	</head>
  	  ...
  	  <body>
          ...
          <nav><ul>
            ...
            <li><a href=\"block2.html\">II Group annotation & stability</a></li>
            <li><a href=\"block3.html\">III Portraying</a></li>
            <li><a class=\"act\" href=\"block4.html\">IV Similarity analyses</a></li>
            <li><a href=\"block5.html\">V Pseudotime estimation</a></li>
          </ul></nav>
        </header>

      <div id=\"wrapper\">
      <h1>Block IV: Similarity analyses</h1>
      Different similariy metrics and methods are applied to the dimension reduced expression module data and metadata, respectively.
      Application of downstream analyses on aggregated data instead of single gene data was shown to increase representativeness and reduce noisiness.<br>
      Similarity analyses are applied to either single- or meta-cells. For single-cell t-SNE and UMAP plots, see 'I Preprocessing & quality check'.
  ...
  filename <- file.path(paste(env$files.name, "- Results"), "html", "block5.html")
  outfile <- file(filename, "w")
      ...
      <html>
    	...
    	<body>
          ...
          <nav><ul>
            ...
            <li><a href=\"block3.html\">III Portraying</a></li>
            <li><a href=\"block4.html\">IV Similarity analyses</a></li>
            <li><a class=\"act\" href=\"block5.html\">V Pseudotime estimation</a></li>
          </ul></nav>
        </header>
  ...
  {
    cat("Pseudotime is estimated using wanderlust algorithm. In brief, this approach generates an ensemble of K-nearest neighbor graphs based on the metagene expression landscape. For each graph, trajectories are calculated and subsequently averaged to obtain the final pseudotime trajectory.<br>
          Similarity analyses are applied to either single- or meta-cells.
