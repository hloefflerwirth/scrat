...
RcppExport SEXP _scrat_calculateDelta(SEXP inputMatrixSEXP, SEXP inputVectorSEXP, SEXP naExistSEXP, SEXP resultDeltaSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _scrat_calculateEuclideanDistances(SEXP deltaMatrixSEXP, SEXP resultEuclideanDistances2SEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _scrat_calculateNeighborhoodMatrix(SEXP winnerNeuronRSEXP, SEXP somSizeSEXP, SEXP radiusSEXP, SEXP resultVectorSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _scrat_matrixToCodebookMatrix(SEXP matrixAsVectorSEXP, SEXP resultSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_scrat_calculateDelta", (DL_FUNC) &_scrat_calculateDelta, 4},
    {"_scrat_calculateEuclideanDistances", (DL_FUNC) &_scrat_calculateEuclideanDistances, 2},
    {"_scrat_calculateNeighborhoodMatrix", (DL_FUNC) &_scrat_calculateNeighborhoodMatrix, 4},
    {"_scrat_matrixToCodebookMatrix", (DL_FUNC) &_scrat_matrixToCodebookMatrix, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_scrat(DllInfo *dll) {
